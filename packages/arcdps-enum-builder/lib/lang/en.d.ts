declare enum e_translate {
    ...
    LANG_PAN_SUMMARY_CRITPCT = 346,
    LANG_PAN_SUMMARY_NINETYPCT = 347,
    LANG_PAN_SUMMARY_FIFTYPCT = 348,
    LANG_PAN_SUMMARY_MOVINGPCT = 349,
    LANG_PAN_SUMMARY_FLANKPCT = 350,
    ...
    LANG_PAN_SUMMARY_PROTPCT = 379,
    LANG_PAN_SUMMARY_KILLINGBLOWS = 380,
    LANG_PAN_SUMMARY_DOWNEDS = 381,
    LANG_PAN_SUMMARY_DOWNEDPCT = 382,
    LANG_PAN_SUMMARY_ZEROES = 383,
    LANG_PAN_SUMMARY_DEATHCOUNT = 384,
    LANG_PAN_SUMMARY_BREAKBAR = 385,
    LANG_PAN_LOGGER_HEADER = 390,
    LANG_PAN_LOGGER_HEADER_CBT = 391,
    ...
    LANG_PAN_LOGGER_SCS = 407,
    LANG_PAN_LOGGER_SCC = 408,
    LANG_PAN_LOGGER_STG = 409,
    LANG_PAN_LOGGER_SAG = 410,
    LANG_PAN_LOGGER_RTH = 411,
    LANG_PAN_LOGGER_CCS = 412,
    LANG_PAN_LOGGER_HS = 413,
    LANG_PAN_LOGGER_UI0 = 414,
    LANG_PAN_LOGGER_UI1 = 415,
    LANG_PAN_LOGGER_HU = 416,
    ...
    LANG_PAN_LOGGER_LINES = 422,
    LANG_PAN_LOGGER_SUPPRESS = 423,
    LANG_PAN_LOGGER_PERFTIME = 424,
    LANG_PAN_LOGGER_PERFUSE = 425,
    LANG_PAN_LOGGER_EVENTS = 426,
    LANG_PAN_LOGGER_CBTSTATECHANGE = 427,
    LANG_PAN_LOGGER_CBTACTIVATION = 428,
    LANG_PAN_LOGGER_CBTBUFFREMOVE = 429,
    LANG_PAN_LOGGER_CBTBUFFAPPLY = 430,
    LANG_PAN_LOGGER_CBTBUFFDAMAGE = 431,
    LANG_PAN_LOGGER_CBTBUFFHEAL = 432,
    LANG_PAN_LOGGER_CBTDIRECTDAMAGE = 433,
    LANG_PAN_LOGGER_CBTDIRECTHEAL = 434,
    LANG_PAN_LOGGER_DEBUG = 435,
    LANG_PAN_LOGGER_CBTMINION = 436,
    LANG_PAN_LOGGER_CBTBREAKBARDAMAGE = 437,
    ...
    LANG_PAN_OPTIONS_INTERFACE = 493,
    ...
    LANG_PAN_OPTIONS_BS_LOGGING = 536,
    ...
    LANG_PAN_OPTIONS_BS_LOGS = 542,
    LANG_PAN_OPTIONS_BS_CONFIG = 543,
    LANG_PAN_OPTIONS_BS_STYLE = 544,
    LANG_PAN_OPTIONS_BS_COLOURSIMGUI = 545,
    LANG_PAN_OPTIONS_BS_COLOURSARC = 546,
    LANG_PAN_OPTIONS_BS_COLOURSPROF = 547,
    LANG_PAN_OPTIONS_BS_COLOURSSQUAD = 548,
    LANG_PAN_OPTIONS_BS_APPEARANCE = 549,
    ...
    LANG_PAN_TEMPLATES_SORTNUMBER = 573,
    ...
    LANG_PAN_TEMPLATES_PREEQUIP = 579,
    LANG_PAN_TEMPLATES_SORTALPHA = 580,
    ...
    LANG_PAN_DETAIL_REMOVED = 614,
    LANG_COMMON_CSK_DODGE = 620,
    LANG_COMMON_CSK_SHIELD = 621,
    LANG_COMMON_CSK_BREAKBAR = 622,
    LANG_COMMON_SKILLS2_NOEVENTS = 630,
    LANG_COMMON_SKILLS2_SHIELDED = 631,
    ...
    LANG_COMMON_SKILLS2_KILLINGBLOWS = 637,
    LANG_COMMON_SKILLS2_DOWNEDS = 638,
    LANG_COMMON_SKILLS2_VALUESHIELD = 639,
    LANG_COMMON_SKILLS2_BLOCKS = 640,
    LANG_COMMON_SKILLS2_EVADES = 641,
    LANG_COMMON_SKILLS2_ABSORBS = 642,
    LANG_COMMON_SKILLS2_ZEROES = 643,
    LANG_COMMON_AS_SUCCESS = 660,
    LANG_COMMON_AS_FAIL = 661,
    LANG_COMMON_AS_PADDING = 662,
    LANG_COMMON_AS_BACKGROUND = 663,
    LANG_COMMON_AS_ONELINE = 664,
    LANG_COMMON_AS_ALIGNRIGHT = 665,
    LANG_COMMON_AS_RESET = 666,
    LANG_COMMON_AS_TOTAL = 667,
    LANG_COMMON_AS_CLEAVE = 668,
    LANG_COMMON_AS_TARGET = 669,
    LANG_COMMON_AS_IN = 670,
    LANG_COMMON_AS_TITLE = 671,
    LANG_COMMON_AS_NOHISTORY = 672,
    LANG_COMMON_AS_AUTOSIZE = 673,
    LANG_COMMON_AS_LISTLENGTH = 674,
    LANG_COMMON_AS_SCROLLBAR = 675,
    LANG_COMMON_AS_FRIENDLY = 676,
    LANG_COMMON_AS_LIST = 677,
    LANG_COMMON_AS_SKILLS = 678,
    LANG_COMMON_AS_TARGETS = 679,
    LANG_COMMON_AS_LOG = 680,
    LANG_COMMON_AS_EXTRAS = 681,
    LANG_COMMON_AS_VERSIONCHECK = 682,
    LANG_COMMON_AS_NOOBLACH = 683,
    LANG_COMMON_AS_NOOBLQUEST = 684,
    LANG_COMMON_AS_NOCOMBATTEXT = 685,
    LANG_COMMON_AS_COMBATTIME = 686,
    LANG_COMMON_AS_SORTDPS = 687,
    LANG_COMMON_AS_STYLE = 688,
    LANG_COMMON_AS_BUFFS = 689,
    LANG_COMMON_AS_SORTTARGET = 690,
    LANG_COMMON_AS_DISPLAY = 691,
    LANG_COMMON_AS_COLOURSUBGROUP = 692,
    LANG_COMMON_AS_FORMATTOOLTIP = 693,
    LANG_COMMON_AS_PLAYERFORMAT = 694,
    LANG_COMMON_AS_DEBUG = 695,
    LANG_COMMON_AS_DATA = 696,
    LANG_COMMON_AS_LABELS = 697,
    LANG_COMMON_AS_NUMBERS = 698,
    LANG_COMMON_AS_PROF = 699,
    LANG_COMMON_AS_TOPSKILLS = 700,
    LANG_COMMON_AS_TOPTARGETS = 701,
    LANG_COMMON_AS_WIDTH = 702,
    LANG_COMMON_AS_DAMAGE = 703,
    LANG_COMMON_AS_TAKEN = 704,
    LANG_COMMON_AS_TITLEMATCHFRAME = 705,
    LANG_COMMON_AS_TITLEFORMATTOOLTIP = 706,
    LANG_COMMON_AS_TITLEFORMAT = 707,
    LANG_COMMON_AS_REC = 708,
    LANG_COMMON_AS_CUR = 709,
    LANG_COMMON_AS_LOGSINVALID = 710,
    LANG_COMMON_AS_MAPRELOAD = 711,
    LANG_COMMON_AS_INTERVAL = 712,
    LANG_COMMON_AS_NAMECHARWIDTH = 713,
    LANG_COMMON_AS_NOOBLEVENT = 714,
    LANG_COMMON_AS_SHOWADVANCEDSTYLEOPTS = 715,
    LANG_COMMON_AS_SHOWADVANCEDSTYLEOPTSINFO = 716,
    LANG_COMMON_AS_SHOWADVANCEDSTYLEOPTSCOL = 717,
    LANG_COMMON_AS_SHOWADVANCEDSTYLEOPTSPREC = 718,
    LANG_COMMON_AS_NAME = 719,
    LANG_COMMON_AS_NAMECOLPROF = 720,
    LANG_COMMON_AS_NAMECOLSUBGROUP = 721,
    LANG_COMMON_AS_SORTSUBGROUP = 722,
    LANG_COMMON_AS_MEMGW2 = 723,
    LANG_COMMON_AS_MEMARC = 724,
    LANG_COMMON_AS_DISTCBT = 725,
    LANG_COMMON_AS_DISTOOC = 726,
    LANG_COMMON_AS_TIMECBT = 727,
    LANG_COMMON_AS_TIMEOOC = 728,
    LANG_COMMON_AS_DETAILED = 729,
    LANG_COMMON_AS_SLOWVATOOLTIP = 730,
    LANG_COMMON_AS_SLOWVA = 731,
    LANG_COMMON_AS_SIMDISABLED = 732,
    LANG_COMMON_AS_SORTADV = 733,
    LANG_COMMON_AS_SORTADVTOOLTIP = 734,
    LANG_COMMON_AS_SHOWADVANCEDSTYLEOPTSTOOLTIP = 735,
    LANG_COMMON_AS_HISTORY = 736,
    LANG_COMMON_AS_SORTADV_ADVANCED = 737,
    LANG_COMMON_AS_SORTADV_FNNONE = 738,
    LANG_COMMON_AS_SORTADV_FNDOWN = 739,
    LANG_COMMON_AS_SORTADV_FNDOWNPERSIST = 740,
    LANG_COMMON_AS_SORTADV_FNDEATH = 741,
    LANG_COMMON_AS_SORTADV_FNDEATHPERSIST = 742,
    LANG_COMMON_AS_SORTADV_FNRESCOUNT = 743,
    LANG_COMMON_AS_SORTADV_FNRESTIME = 744,
    LANG_COMMON_AS_SORTADV_FNCLEANSE = 745,
    LANG_COMMON_AS_SORTADV_FNSTRIP = 746,
    LANG_COMMON_AS_SORTADV_FNDPSOUTPERSIST = 747,
    LANG_COMMON_AS_SORTADV_FNDPSINPERSIST = 748,
    LANG_COMMON_AS_STATSEXCLUDE = 749,
    LANG_COMMON_AS_STATSEXCLUDETOOLTIP = 750,
    LANG_COMMON_AS_STATSEXCLUDEACTIVE = 751,
    LANG_COMMON_AS_STATSEXCLUDEVSPLAYER = 752,
    LANG_COMMON_AS_STATSEXCLUDEVSNPC = 753,
    LANG_COMMON_AS_STATSEXCLUDEVSGADGET = 754,
    LANG_COMMON_AS_STATSEXCLUDEFROMPLAYER = 755,
    LANG_COMMON_AS_STATSEXCLUDEFROMNPC = 756,
    LANG_COMMON_AS_STATSEXCLUDEFROMGADGET = 757,
    LANG_COMMON_AS_OPTSINTERFACETOOLTIP = 758,
    LANG_COMMON_AS_OPTSLOGSTOOLTIP = 759,
    LANG_COMMON_AS_OPTSEXTRASTOOLTIP = 760,
    LANG_COMMON_AS_OPTSPLAYERTOOLTIP = 761,
    LANG_COMMON_AS_OPTSDISPLAYTOOLTIP = 762,
    LANG_COMMON_AS_OPTSSTYLETOOLTIP = 763,
    LANG_COMMON_AS_PERSISTRESET = 764,
    LANG_COMMON_AS_SORTADV_FNDPSOUTSQ = 765,
    LANG_COMMON_AS_SORTADV_FNDPSINSQ = 766,
    LANG_COMMON_AS_ALWAYSSHOWWINDOWS = 767,
    LANG_COMMON_AS_PERSISTPARTYRESET = 768,
    LANG_COMMON_AS_PERSISTPROFRESET = 769,
    LANG_COMMON_AS_DETAILDEFAULT = 770,
    LANG_COMMON_AS_DETAILDEFAULTTOOLTIP = 771,
    LANG_COMMON_AS_SAVEWVWLOGS = 772,
    LANG_COMMON_AS_SAVEWVWLOGSTHRESHOLDMIN = 773,
    LANG_COMMON_AS_SAVEWVWLOGSTHRESHOLDMAX = 774,
    LANG_COMMON_AS_SAVEWVWLOGSTOOLTIP = 775,
    LANG_COMMON_AS_DMGOUT = 776,
    LANG_COMMON_AS_DMGIN = 777,
    LANG_COMMON_AS_SAVEWVWLOGSENEMYMIN = 778,
    LANG_COMMON_AS_ADVANCEDFUNCOPTS = 779,
    LANG_COMMON_AS_SHOWADVANCEDFUNCOPTS = 780,
    LANG_COMMON_AS_SHOWADVANCEDFUNCOPTSTOOLTIP = 781,
    LANG_COMMON_AS_DRAWCOMPAT = 782,
    LANG_COMMON_AS_SAVEPROFKEYBINDS = 783,
    LANG_COMMON_AS_SAVEPROFKEYBINDSTOOLTIP = 784,
    LANG_COMMON_AS_SHOWTARGETINFO = 785,
    LANG_COMMON_AS_TARGETINFOTARGET = 786,
    LANG_COMMON_AS_PERSISTBUILDRESET = 787,
    LANG_COMMON_AS_OPTSTIME = 788,
    LANG_COMMON_AS_OPTSTIMETOOLTIP = 789,
    LANG_COMMON_AS_OPTSTIME_USEDMG = 790,
    LANG_COMMON_AS_DRAWBARS = 791,
    LANG_COMMON_AS_SUBGROUP = 792,
    LANG_COMMON_AS_TOPSUBGROUPS = 793,
    LANG_COMMON_AS_BUFFTOTAL = 794,
    LANG_COMMON_AS_MAP_MAPASSETTIMEOUT = 795,
    LANG_COMMON_AS_MAP_MAPASSETTIMEOUTTOOLTIP = 796,
    LANG_COMMON_AS_MAP_MAPTIMEOUT = 797,
    LANG_COMMON_AS_MAP_MAPTIMEOUTTOOLTIP = 798,
    LANG_COMMON_AS_MAP_MODELTIMEOUT = 799,
    LANG_COMMON_AS_MAP_MODELTIMEOUTTOOLTIP = 800,
    LANG_COMMON_AS_MAP = 801,
    LANG_COMMON_AS_LOGCH_COMBATLOCAL = 802,
    LANG_COMMON_AS_LOGCH_COMBATAREASELF = 803,
    LANG_COMMON_AS_LOGCH_COMBATAREASQUAD = 804,
    LANG_COMMON_AS_LOGCH_ENGINE = 805,
    LANG_COMMON_AS_HIDEINCOMBAT = 806,
    LANG_COMMON_AS_BEHAVIOR = 807,
    LANG_COMMON_AS_NEEDSRESTART = 808,
    LANG_COMMON_AS_HISTORICAL = 809,
    LANG_COMMON_AS_UEH = 810,
    LANG_COMMON_AS_FONTSIZE = 811,
    LANG_COMMON_AS_FONTSIZETOOLTIP = 812,
    LANG_COMMON_AS_LOGSPATH = 813,
    LANG_COMMON_AS_LOGSPATHTOOLTIP = 814,
    LANG_COMMON_AS_BUFFIDS = 815,
    LANG_COMMON_AS_BUFFIDSAPPLY = 816,
    LANG_COMMON_AS_BOSSIDS = 817,
    LANG_COMMON_AS_BOSSIDSTOOLTIP = 818,
    LANG_COMMON_AS_BOSSIDSAPPLY = 819,
    LANG_COMMON_AS_KEYS = 820,
    LANG_COMMON_AS_KEYS_UNSET = 821,
    LANG_COMMON_AS_KEYS_MOD1 = 822,
    LANG_COMMON_AS_KEYS_MOD2 = 823,
    LANG_COMMON_AS_KEYS_MODMULTI = 824,
    LANG_COMMON_AS_KEYS_HIDE = 825,
    LANG_COMMON_AS_KEYS_OPTIONS = 826,
    LANG_COMMON_AS_KEYS_CHCLI = 827,
    LANG_COMMON_AS_KEYS_BUFFS = 828,
    LANG_COMMON_AS_KEYS_SELF = 829,
    LANG_COMMON_AS_LOG_TO_FILE = 830,
    LANG_COMMON_AS_DODGEUPTIME = 831,
    LANG_COMMON_AS_SORTADV_FNSTRIPPERSIST = 832,
    LANG_COMMON_AS_SORTADV_FNCLEANSEPERSIST = 833,
    LANG_COMMON_AS_SORTADV_UNITSPERSEC = 834,
    LANG_COMMON_AS_SORTADV_UNITSSECS = 835,
    LANG_COMMON_AS_WINDOW_POSITION = 836,
    LANG_COMMON_AS_WINDOW_POSITIONTOOLTIP = 837,
    LANG_COMMON_AS_WINDOW_USE_FIXED = 838,
    LANG_COMMON_AS_WINDOW_OFFS_POINT_TL = 839,
    LANG_COMMON_AS_WINDOW_OFFS_POINT_TR = 840,
    LANG_COMMON_AS_WINDOW_OFFS_POINT_BL = 841,
    LANG_COMMON_AS_WINDOW_OFFS_POINT_BR = 842,
    LANG_COMMON_AS_WINDOW_OFFS_X = 843,
    LANG_COMMON_AS_WINDOW_OFFS_Y = 844,
    LANG_COMMON_AS_WINDOW_USE_RELATIVE = 845,
    LANG_COMMON_AS_WINDOW_RELATIVE_WINDOW = 846,
    LANG_COMMON_AS_WINDOW_RELATIVE_POINTATTACHTO = 847,
    LANG_COMMON_AS_WINDOW_RELATIVE_POINTATTACHFROM = 848,
    LANG_COMMON_AS_WINDOW_USE_SURROUND = 849,
    LANG_COMMON_AS_WINDOW_RESETALL = 850,
    LANG_COMMON_AS_TTS = 851,
    LANG_COMMON_AS_SEPARATE_EXCLUDES = 852,
    LANG_COMMON_AS_SEPARATE_EXCLUDESTOOLTIP = 853,
    LANG_COMMON_AS_GLOBAL_EXCLUDESTOOLTIP = 854,
    LANG_COMMON_AS_SORTADV_FNDISTTOTAGPERSIST = 855,
    LANG_COMMON_AS_SORTADV_FNDISTTOTAGSQ = 856,
    LANG_COMMON_AS_WVW = 857,
    LANG_COMMON_AS_PVE = 858,
    LANG_COMMON_AS_SORTADVTOOLTIPNONE = 859,
    LANG_COMMON_AS_SORTADVTOOLTIPSQCURRENT = 860,
    LANG_COMMON_AS_SORTADVTOOLTIPAVERAGED = 861,
    LANG_COMMON_AS_SORTADVTOOLTIPPLAYER = 862,
    LANG_COMMON_AS_PERSISTTOOLTIP = 863,
    LANG_COMMON_AS_SORTADV_FNKILLSOUTPERSIST = 864,
    LANG_COMMON_AS_SORTADV_FNKILLSOUTSQ = 865,
    LANG_COMMON_AS_SORTADV_FNDOWNSOUTPERSIST = 866,
    LANG_COMMON_AS_SORTADV_FNDOWNSOUTSQ = 867,
    LANG_COMMON_AS_HIGHLIGHTLOADINGRED = 868,
    LANG_COMMON_AS_PERSIST = 869,
    LANG_COMMON_AS_GLOBAL_OPTSSLIDINGTOOLTIP = 870,
    LANG_COMMON_AS_SEPARATE_OPTSSLIDINGTOOLTIP = 871,
    LANG_COMMON_AS_OPTSSLIDING = 872,
    LANG_COMMON_AS_OPTSAPPEARANCETOOLTIP = 873,
    LANG_COMMON_AS_COPYSELFTOP = 874,
    LANG_COMMON_AS_HIDESELF = 875,
    LANG_COMMON_AS_COLOURSARCCHCLI = 876,
    LANG_COMMON_AS_COLOURSARCBUFFS = 877,
    LANG_COMMON_AS_COLOURSARCLISTS = 878,
    LANG_COMMON_AS_DEFENSIVE = 879,
    LANG_COMMON_AS_DRAWDAMAGE = 880,
    LANG_COMMON_AS_RESETSTYLE = 881,
    LANG_COMMON_AS_SORTADV_FNBREAKBARPERSIST = 882,
    LANG_COMMON_AS_SORTADV_FNBREAKBARSQ = 883,
    LANG_COMMON_AS_LOGCH_EXTENSION = 884,
    LANG_COMMON_AS_CUSTOMNAME = 885,
    LANG_COMMON_AS_MANUAL = 886,
    LANG_COMMON_AS_CLICKMODTOOLTIP = 887,
    LANG_COMMON_AS_PINGHIGHLIGHTSPIKE = 888,
    LANG_COMMON_AS_SERVERTICKHIGHLIGHTSPIKE = 889,
    LANG_COMMON_AS_METRICFORMATTOOLTIP = 890,
    LANG_COMMON_AS_METRICFORMAT = 891,
    LANG_COMMON_AS_PROFICONS = 892,
    LANG_COMMON_AS_SUBGROUPAVERAGE = 893,
    LANG_COMMON_AS_MAXACTIVEESTACKS = 894,
    LANG_COMMON_AS_ONETARGETNOMINAL = 895,
    LANG_COMMON_AS_FIVETARGETNOMINAL = 896,
    LANG_COMMON_AS_TENTARGETNOMINAL = 897,
    LANG_COMMON_AS_PROFICONSTOOLTIP = 898,
    LANG_COMMON_AS_ERRORS = 899,
    LANG_COMMON_AS_BUFFLISTSTOOLTIP = 900,
    LANG_COMMON_AS_BUFFLIST = 901,
    LANG_COMMON_AS_LIMITNOMINALMAXIMUM = 902,
    LANG_COMMON_AS_SHOWTABS = 903,
    LANG_COMMON_AS_OUT = 904,
    LANG_COMMON_AS_LIMITNOMINALMINIMUM = 905,
    LANG_COMMON_AS_SQSTAT_TITLE = 906,
    LANG_COMMON_AS_SQSTAT_DPSOUT = 907,
    LANG_COMMON_AS_SQSTAT_DPSIN = 908,
    LANG_COMMON_AS_SQSTAT_CLEANSEOUT = 909,
    LANG_COMMON_AS_SQSTAT_CLEANSEIN = 910,
    LANG_COMMON_AS_SQSTAT_STRIPOUT = 911,
    LANG_COMMON_AS_SQSTAT_STRIPIN = 912,
    LANG_COMMON_AS_SQSTAT_BUFFOUT = 913,
    LANG_COMMON_AS_SQSTAT_BUFFIN = 914,
    LANG_COMMON_AS_SQSTAT_SQUADROWS = 915,
    LANG_COMMON_AS_SQSTAT_MAX = 916,
    LANG_COMMON_AS_SQSTAT_TIMING = 917,
    LANG_COMMON_AS_SQSTAT_TIMINGTOOLTIP = 918,
    LANG_COMMON_AS_KEYS_GRAPHS = 919,
    LANG_COMMON_AS_DEFAULTSQUADLOGNAME = 920,
    LANG_COMMON_AS_TARGETHISTMBUSE = 921,
    LANG_COMMON_AS_OPTSHISTORICALTOOLTIP = 922,
    LANG_COMMON_AS_TIMESTRIDE = 923,
    LANG_COMMON_AS_SQSTAT_LASTMS = 924,
    LANG_COMMON_AS_MINLOGDURATION = 925,
    LANG_COMMON_AS_SQSTAT_HIDEPLAYER = 926,
    LANG_COMMON_AS_SQSTAT_HIDEPROF = 927,
    LANG_COMMON_AS_SQSTAT_UNHIDEALL = 928,
    LANG_COMMON_AS_SQSTAT_MULTIPLEGRAPHWARNING = 929,
    LANG_COMMON_AS_PROF_UNKNOWN = 930,
    LANG_COMMON_AS_PROF_GUARDIAN = 931,
    LANG_COMMON_AS_PROF_WARRIOR = 932,
    LANG_COMMON_AS_PROF_ENGINEER = 933,
    LANG_COMMON_AS_PROF_RANGER = 934,
    LANG_COMMON_AS_PROF_THIEF = 935,
    LANG_COMMON_AS_PROF_ELEMENTALIST = 936,
    LANG_COMMON_AS_PROF_MESMER = 937,
    LANG_COMMON_AS_PROF_NECROMANCER = 938,
    LANG_COMMON_AS_PROF_REVENANT = 939,
    LANG_COMMON_AS_SQSTAT_GRANULARITY = 940,
    LANG_COMMON_AS_SQSTAT_ROLLING = 941,
    LANG_COMMON_AS_SQSTAT_ROLLINGTOOLTIP = 942,
    LANG_COMMON_AS_SQSTAT_NONSELECTALPHA = 943,
    LANG_COMMON_AS_SQSTAT_NONHIGHLIGHTALPHA = 944,
    LANG_COMMON_AS_SQSTAT_AUTOSELECTSELF = 945,
    LANG_COMMON_AS_SQSTAT_BUFFSELECTTOOLTIP = 946,
    LANG_COMMON_AS_SQSTAT_BUFFSELECT = 947,
    LANG_COMMON_AS_SQSTAT_LIST = 948,
    LANG_COMMON_AS_SQSTAT_HIGHLIGHTUSEPROF = 949,
    LANG_COMMON_AS_SQSTAT_USEPLAYERUNIQUECOLOURS = 950,
    LANG_COMMON_AS_COLOURSARCGRAPHS = 951,
    LANG_COMMON_AS_TIMERANGE = 952,
    LANG_COMMON_AS_HOSTILE = 953,
    LANG_COMMON_AS_FRIENDLY = 954,
    LANG_COMMON_AS_RANGE = 955,
    LANG_COMMON_AS_BUFFIN = 956,
    LANG_COMMON_AS_BUFFOUT = 957,
    LANG_COMMON_AS_SHOWHIDDEN = 958,
    LANG_COMMON_AS_HIDDEN = 959,
    LANG_COMMON_AS_SHOWTARGET = 960,
    LANG_COMMON_AS_SQSTAT_DPSOUT_TARGET = 961,
    LANG_COMMON_AS_SQSTAT_DPSIN_TARGET = 962,
    LANG_COMMON_AS_SUBGROUPAVGONLY = 963,
    LANG_COMMON_AS_NOALLFLOATTEXT = 964,
    LANG_COMMON_AS_SHOWMINMAXINDICATOR = 965,
    LANG_COMMON_AS_SAVEWVWLOGSTHRESHOLDSQUADPCT = 966,
    LANG_COMMON_AS_CSKSELFCAST = 967,
    LANG_COMMON_AS_CSKENEMYCAST = 968,
    LANG_COMMON_AS_SUMMARYONACTIVATECOUNT = 969,
    LANG_COMMON_AS_SUMMARYSTRIKETOTAL = 970,
    LANG_COMMON_AS_SUMMARYCONDITIONTOTAL = 971,
    LANG_COMMON_AS_PADSPACES = 972,
    LANG_COMMON_AS_PERSISTMAPRESET = 973,
    LANG_COMMON_AS_SORTADV_FNDOWNCONTRIBPERSIST = 974,
    LANG_COMMON_AS_SORTADV_FNDOWNCONTRIBSQ = 975,
    LANG_COMMON_AS_SQUADSTATS = 976,
    LANG_COMMON_AS_PERSISTSTATS = 977,
    LANG_COMMON_AS_WVWINACTIVE = 978,
    LANG_END = 979
}
export { e_translate };
declare const lang: {
